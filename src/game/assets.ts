...
function createBlockTexture(scene: Phaser.Scene, color: PigColor, style: ColorStyle): void {
  ...
  g.fillStyle(0x050915, 0.56);
  g.fillEllipse(72, 110, 124, 38);
